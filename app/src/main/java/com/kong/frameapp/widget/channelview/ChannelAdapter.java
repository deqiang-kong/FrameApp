...
import com.kong.frameapp.widget.channelview.helper.OnDragVHListener;
import com.kong.frameapp.widget.channelview.helper.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    // 我的频道可编辑类型
    public static final int MY_EDIT_Y = 0;
    // 我的频道不可编辑类型
    public static final int MY_EDIT_N = 1;
    ...
    private static final long SPACE_TIME = 160;
    ...
    private List<ChannelInfo> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;


    public ChannelAdapter(Context context, ItemTouchHelper helper, List<ChannelInfo> mMyChannelItems, List<ChannelInfo> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.channel_my_header, parent, false);
                ...
                holder.tvBtnEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!isEditMode) {
                            ...
                            holder.tvBtnEdit.setText(R.string.channel_finish);
                        } else {
                            cancelEditMode((RecyclerView) parent);
                            holder.tvBtnEdit.setText(R.string.channel_edit);
                        }
                    }
                });
                return holder;
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.channel_item_my, parent, false);
                ...
                myHolder.textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        ChannelInfo mBean = mMyChannelItems.get(position - COUNT_PRE_MY_HEADER);
                        int type = mBean.getType();

                        if (isEditMode && type == MY_EDIT_Y) {
                    ...
                    public boolean onLongClick(final View v) {
                        ...
                        if (isEditMode && type == MY_EDIT_Y) {
                            ...
                            if (view == recyclerView.getLayoutManager().findViewByPosition(0)) {
                                ...
                                tvBtnEdit.setText(R.string.channel_finish);
                            }
                        }
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.channel_other_header, parent, false);
                return new RecyclerView.ViewHolder(view) {
                };

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.channel_item_other, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            //根据类型设定可编辑状态
            if (MY_EDIT_N == type) {
                myHolder.textView.setBackgroundResource(R.drawable.bg_channel_f);
                myHolder.setType(MY_EDIT_N);
                myHolder.imgEdit.setTag(MY_EDIT_N);
            } else {
                myHolder.setType(MY_EDIT_Y);
                myHolder.imgEdit.setTag(MY_EDIT_Y);
            }
            myHolder.textView.setText(mBean.getName());
            //可编辑状态 && 可编辑项
            if (isEditMode && MY_EDIT_N == type) {
        ...
        //编辑标签
            ...
            if (isEditMode) {
                headerHolder.tvBtnEdit.setText(R.string.channel_finish);
            } else {
                headerHolder.tvBtnEdit.setText(R.string.channel_edit);
            }
        }
    }
    ...
    public List<ChannelInfo> getMyChannelItems(){
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        ChannelInfo item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        ChannelInfo item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        ChannelInfo item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
