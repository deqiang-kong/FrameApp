package com.kong.frameapp.widget;
...
public class ThreePointLoadingView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // 考虑padding值
        mWidth = measureSize(widthMeasureSpec, dip2px(getContext(), 180)) + getPaddingLeft() + getPaddingRight();
        mHeight = measureSize(heightMeasureSpec, dip2px(getContext(), 180)) + getPaddingTop() + getPaddingBottom();
