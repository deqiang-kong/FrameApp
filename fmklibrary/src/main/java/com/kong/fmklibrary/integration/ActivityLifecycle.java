 ...
 */
package com.kong.fmklibrary.integration;
...
import com.kong.fmklibrary.base.delegate.ActivityDelegate;
import com.kong.fmklibrary.base.delegate.ActivityDelegateImpl;
import com.kong.fmklibrary.base.delegate.IActivity;
...
public class ActivityLifecycle implements Application.ActivityLifecycleCallbacks {
     ...
     * 设置是否使用监听,如果这个 Activity 返回 false 的话,这个 Activity 下面的所有 Fragment 将不能使用 {@link }
     * 意味着 {@link } 也不能使用
     *
     * @param activity
     */
